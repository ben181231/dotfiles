...
plugins=(git github aws docker docker-compose kubectl yarn)
...
export PATH="$GOPATH/bin:$GEM_HOME/bin:$ICU_PATH:$X11_HOME/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin"
export GPG_TTY=$(tty)
